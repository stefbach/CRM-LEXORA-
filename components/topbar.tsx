  ...
  return (
    <header className="flex h-16 shrink-0 items-center gap-4 border-b border-white/5 bg-ink-950/40 px-6 backdrop-blur-xl lg:px-10">
      ...
      <div className="ml-auto flex items-center gap-2">
        <button className="inline-flex h-10 items-center gap-2 rounded-xl bg-gradient-to-br from-brand-500 to-brand-600 px-4 text-sm font-medium text-white shadow-glow transition hover:brightness-110">
